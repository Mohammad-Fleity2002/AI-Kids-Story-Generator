...
// // import { v4 as uuidv4 } from "uuid4"; // For generating unique IDs
...
//             const filename = `${sanitizedTitle}_${uniqueCode}.png`; // Combine title and unique code
//             const filePath = path.join(process.cwd(), "public", "images", filename); // Save in the `public/images` folder

//             // Save the image to the file system
//             await writeFile(filePath, buffer);

//             // Return the URL to access the saved image
//             const imageUrl = `/images/${filename}`; // Public URL to the image
